...
/*	if(! notNull(self.document.frmdetinsert.sectionname,"Section Name cannot be empty !!"))
	{
		return false;
	}
	if (self.document.frmdetinsert.sectionname.value.length>25)
	{
		alert("Section Name cannot be more than 25 characters !!");
...
*/	if(! notNull(self.document.frmdetinsert.noquest,"# of Questions cannot be empty !!"))
	...
	if(!checkNumeric(self.document.frmdetinsert.noattemptsallowed,"# of Attempts Allowed is a Numeric Field !!"))
	{
		return false;
	}
	if(! notNull(self.document.frmdetinsert.noattemptsallowed,"# of Attempts Allowed cannot be empty but can be 0 !!"))
	{ 
		return false;
	}
	if (self.document.frmdetinsert.noattemptsallowed.value>999)
	{
		alert("# of Attempts Allowed cannot be more than 999 !!");
		self.document.frmdetinsert.noattemptsallowed.value="";
