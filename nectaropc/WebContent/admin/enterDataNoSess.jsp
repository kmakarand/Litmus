...
%></td></br>
 ...
 <%		Statement stat=null,statimage=null;
		...
		String a11="",a21="",a31="",a41="",a51="",ai="",bi="",ci="",di="",quesi="",expi="",marks="";
		int qno=0,ans1=0;
		int partyid=0;
		try{
		...
		options=Integer.parseInt(request.getParameter("option"));
		...
		if (options==2){
		 ...
		 subjectid=checker.check(request.getParameter("subjectid"));
...
%><br><br><br><br><br><br><br><br>
	...
	%>
								<%out.print("<h3>Question ID : "+qno+"<h3><br><br><br>");%>
...
<jsp:param name="employee" value="2"/>
  ...
  <td align="left"><a href='AddQuestionNoSess.jsp'>More Questions</a></td><br><td align="center"><a href='../servlet/ExamTestDetailNumber1?tablename=QuestionMaster&editmodify=modrecords&questionNumber=<%=qno%>'>Edit/Delete</a></td>
