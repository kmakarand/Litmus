...
<%@page import="com.ngs.EntityManagerHelper,org.apache.commons.io.filefilter.WildcardFileFilter,org.apache.commons.io.FilenameUtils"%>
...
Query query = null;String varExamID ="";String flag="";String filename="";String fileList="";String datasheetname="";
String action = request.getParameter("action");String filepath ="";String AbsolutePath="";
...
%>
		 	...
		 	<tr><td>Data Sheet Name: </td><td><input type=text name="datasheetname" width=5></td></tr><br>
...
else
{
        ...
        AbsolutePath = getServletContext().getRealPath("/admin/");
		...
		int rowcount=0;
	 	...
	 	try{
		    ...
		    datasheetname=request.getParameter("datasheetname");
			System.out.println("filename	:"+filename);
 			System.out.println("fileList	:"+fileList);
 			
 			String extension = FilenameUtils.getExtension(fileList);
			System.out.println("extension	:::::::::::::::::::::::::::::::::::::"+extension);
			System.out.println("Filetype :"+extension);
			
			if(extension.equals("xls"))
			{
				ReadExcelFile.readXLS(AbsolutePath,filename,fileList,varExamID,queNumber,datasheetname);
				System.out.println("loadExcelData Success:");
				%>
				...
				<%
				/*String resultMessage = "Data loaded Sucessfully !!";
				request.setAttribute("Message", resultMessage);
				getServletContext().getRequestDispatcher("/admin/success.jsp").forward(request, response);*/
				
			}
			else if(extension.equals("xlsx"))
			{
				ReadExcelFile.readXLSX(AbsolutePath,filename,fileList,varExamID,queNumber,datasheetname);
				System.out.println("loadExcelData Success:");
				%>
				<jsp:forward page="success.jsp"> 
				<jsp:param name="fileList" value="<%=fileList%>"/> 
			...
			{
				System.out.println("loadExcelData Failure:");
			}
