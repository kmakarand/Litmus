...
stmt.executeUpdate("DELETE from HierMenuRights WHERE GroupID='" +rightname+ "'");
...
stmtupd.executeUpdate("INSERT INTO HierMenuRights(GroupID,MenuID) VALUES(\'"+rightname+"\',\'"+ischecked+"\')");
			}//end of null
		}//end of result set
%>
