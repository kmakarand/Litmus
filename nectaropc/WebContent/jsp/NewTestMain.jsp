...
<%
	...
	System.out.println("CodeID :"+AllCodes);
	...
	if(teststart.equals("start"))
	{
		...
		System.out.println("select QuestionID,LevelID  from QuestionMaster where ExamID="+ExamID+" and (CodeID LIKE '"+AllCodes+"') order by LevelID,QuestionID");
...
//						{refresh=true;}
						...
						System.out.println("time left:::::::::::::::::::::::"+tleft);
							...
							try
							{
								...
								else if(TimerType==3)
								{
									if((tleft!=null)&&(!tleft.equals("undefined"))&&(!tleft.equals("")))
									{
										...
										System.out.println("TimerType==3TimerType==3Timer : " +"Update ExamStatus SET TimeLeft="+timeleft+" WHERE CandidateID="+CandidateID);
									}
								}
