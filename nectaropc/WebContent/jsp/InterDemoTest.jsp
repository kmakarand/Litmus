...
<%
	...
	if(action==null)
	{
		...
		try
		{
			rs1=  s1.executeQuery("Select QuestionID from QuestionMaster where ExamID=932");
		}
...
<%
	...
	out.println("</form>");
		...
		<th align='right'>
		<div align="right">
		<A HREF="javascript:OpenCalculator('Calculator.htm');">Click here</A> to open Calculator.
		</th>
		</tr>
		</table>
		</th>
		...
		<th colspan=2 align="left">
		<table  border="0" cellspacing="0" cellpadding="1" width="100%">
		<tr><th><b>Marks for Question:1</th></tr>
		</table>
		</th>
		</tr>
		<tr>
	...
	if(OnPage.equals("bookmark"))
		{
			...
			out.println("<tr><th colspan=3 align=center><div class='clsNavigation'><input type=submit value=\"Go back to Test\" onClick=\"return  showval()\"></div></th></tr></table>");
		}
