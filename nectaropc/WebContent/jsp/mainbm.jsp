...
<%
	...
	//System.out.println("if(top.temp2) top.location.href='mainbm.jsp?id=" + request.getParameter("id") +"&qans=" + request.getParameter("qans")+"&questimer="+request.getParameter("questimer")+"&timeleft="+request.getParameter("timeleft")+"'");
	out.println("if(top.temp2) top.location.href='mainbm.jsp?id=" + request.getParameter("id") +"&qans=" + request.getParameter("qans")+"&questimer="+request.getParameter("questimer")+"&timeleft="+request.getParameter("timeleft")+"'");
	out.println("</script>");
...
<% out.println("<frame src=TestMainbm.jsp?"+values+" name=\"temp2\">");%>	
	<!--<frame src="TestMainbm.jsp" name="temp2">-->
