...
public class Way2SMS {
    ...
    {
    	System.out.println("loginWay2SMS	1:");
        //String cookie=null;
        URL urlLogin;
        String loginContent;
        ...
        System.out.println("loginWay2SMS sessionCookie 2:"+sessionCookie);
        return cookie;
    ...
    {
    		System.out.println("sendSMS	Message 1:");
            ...
            System.out.println("sendSMS	phoneNumber 2:"+phoneNumber);
            ...
            System.out.println("sendSMS	Message 3:"+message);
            URL sendURL;
            ...
            try {
                ...
                sendContent="custid=undefined&HiddenAction=instantsms&Action="+action+"&login="+phoneNumber+"&pass="+pass+"&MobNo="+ phoneNumber+ "&textArea="+message;
