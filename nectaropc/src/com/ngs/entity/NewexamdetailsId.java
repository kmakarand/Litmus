...
/**
 * NewexamdetailsId entity. @author MyEclipse Persistence Tools
 */
@Embeddable
@NamedQueries({@NamedQuery(name="AddScheduleForm-NewexamdetailsId.sql3",
			query="SELECT nxid.examId,nxid.testName FROM NewexamdetailsId nxid"),
			
			@NamedQuery(name="Analysis-NewExamDetailsId.sql4",
			query="SELECT nxid.sectionId,nxid.testName from NewExamDetails nxid where nxid.examId =:examid " +
					"GROUP BY SectionID"),
					
			@NamedQuery(name="Analysis-NewExamDetailsId.sql7",
			query="SELECT nxid.negativeMarks from NewExamDetailsId nxid where nxid.examId=:exid"),
			
			@NamedQuery(name="Analysis-NewexamdetailsId.sql13",
			query="SELECT nxdid.testName FROM NewexamdetailsId nxdid WHERE nxdid.examId=:examid and nxdid.sectionId=:sectionid"),	
		
			@NamedQuery(name="Analysis-NewexamdetailsId.sql20",
			query="Select nxdid.noOfQuestions,nxdid.levelId from NewexamdetailsId nxdid where examId=:examid and SectionID=:sectionid")	
					
			
		})

public class NewexamdetailsId implements java.io.Serializable {
	...
	/** default constructor */
	public NewexamdetailsId() {
	}

	/** minimal constructor */
	public NewexamdetailsId(Integer examId, Integer sectionId,
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof NewexamdetailsId))
			return false;
		NewexamdetailsId castOther = (NewexamdetailsId) other;
