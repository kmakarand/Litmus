...
import com.ngs.dao.AddressdetailsDAO;
import com.ngs.dao.LocationmasterDAO;
import com.ngs.entity.Addressdetails;
import com.ngs.entity.AddressdetailsId;
	...
	public void Add(HttpServletRequest req,HttpServletResponse res) throws ServletException,IOException
	{
		...
		try
		{
			...
			else
			{
				...
				AddressdetailsId adid = new AddressdetailsId();
				EntityManagerHelper.beginTransaction();
				adid.setCandidateId(cid);
				adid.setTypeOfAddress(typeofadd);
				//ad.setId(adid);
