...
public class CopyOfJDBCMenuBuilder implements MenuBuilder
{
    private int coord=0;
    ...
    public CopyOfJDBCMenuBuilder(String driver, String url, String username, String password)
    {
    	try{
           this.driver = driver;
           this.url = url;
    ...
    {
        CopyOfJDBCMenuBuilder builder = new CopyOfJDBCMenuBuilder("com.mysql.jdbc.Driver", "jdbc:mysql://localhost:3306/nectar?autoReconnect=true", "nectar", "nec76tar");
